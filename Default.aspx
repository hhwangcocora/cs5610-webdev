...
<div class="container top-margin-10">
    <div id="homePage" class="tabs  top-margin-100">
        <div class="row">
            ...
            <div class="col-7">
                <img src="images/homepage/name.png" class="name-picture">
                ...
                <div class="blue text-small text-aria top-margin-5">Email me at wang.huih@husky.neu.edu</div>
                ...
                <div class="row">
                    <div class="accordion top-margin-10">
                        ...
                        <div class="accordion-content" id="document">
                            <p class="blue text-aria">Click to visit the page <a href="http://nodejs-hhwang.rhcloud.com/documents/">Documents</a></p>
...
<div class="footer align-center top-margin-50">
    <div class="row align-center">
        <div class="white col-1 align-right top-margin-5"><a href="source/" target="_blank">Source</a></div>
        <div class="white col-1 align-right top-margin-5"><a href="search/"  target="_blank">Search</a></div>
        <div class="white col-1 align-right top-margin-5"><a href="searchtree/"  target="_blank">SearchTree</a></div>
        <div class="white col-1 align-right top-margin-5"><a href="textview/"  target="_blank">TextView</a></div>
        <div class="white col-1 align-right top-margin-5"><a href="filelist.aspx" target="_blank">FileList</a></div>
        <div class="white col-1 align-right top-margin-5"><a href="autofile.aspx" target="_blank">AutoFile</a></div>
        <div class="white col-1 align-right top-margin-5"><a href="images/autoimage.aspx" target="_blank">Images</a></div>
        <div class="white col-1 align-right top-margin-5"><a href="blog/" target="_blank">Blog</a></div>
    </div>
</div>
</body>
